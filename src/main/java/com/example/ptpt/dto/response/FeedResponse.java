...
public class FeedResponse {
    ...
    @Schema(description = "작성자명", example = "홍길동", defaultValue = "홍길동")
    ...
    @Schema(
            ...
            example = "/feeds/images/health.png"
    )
    ...
    @Schema(description = "현재 사용자가 좋아요를 눌렀는지 여부", example = "true", defaultValue = "false")
