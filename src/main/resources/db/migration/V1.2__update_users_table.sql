...
-- 3. 새로운 프로필·소셜·동의·상태·로그인 관련 컬럼 추가
-- 4. user_type, is_active, is_email_verified 기본값 설정
-- 5. 인덱스·유니크 제약 조건 추가
...
ALTER TABLE users
    ...
    ADD COLUMN social_profile_image VARCHAR(500) NULL COMMENT '소셜에서 가져온 원본 프로필 이미지 URL',
